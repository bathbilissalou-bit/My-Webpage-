  ...
  const products = [
    {
      ...
      description: "Deep navy with signature embroidered pocket detail. Structured, sharp, and unmistakably HavrePlacide.",
      price: "$350 – $400",
    ...
    },
    {
      ...
      description: "Natural linen in soft grey with hand-stitched ornamental patterns. Light, refined, and effortlessly elegant.",
      price: "$350 – $400",
    ...
    },
    {
      id: 3,
      name: "Tunique Grège",
      description: "Soft greige with twin floral-embroidered chest pockets and polished cufflink finish. Subtle luxury in every detail.",
      price: "$350 – $400",
