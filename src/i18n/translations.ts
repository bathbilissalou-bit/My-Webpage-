...
export const t = {
  ...
  measurements: {
    ...
    chestPH:       s("Chest (inches)",  "Poitrine (pouces)", "Pecho (pulgadas)"),
    waistPH:       s("Waist (inches)",  "Taille (pouces)",   "Cintura (pulgadas)"),
    heightPH:      s("Height (inches)", "Hauteur (pouces)",  "Altura (pulgadas)"),
    ...
    calcBtn:       s("Get My Size",     "Obtenir Ma Taille", "Obtener Mi Talla"),
